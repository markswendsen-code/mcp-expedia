/**
 * Strider Labs - Expedia Auth/Session Management
 *
 * Handles cookie persistence and session management for Expedia.
 */
...
const CONFIG_DIR = path.join(os.homedir(), ".striderlabs", "expedia");
